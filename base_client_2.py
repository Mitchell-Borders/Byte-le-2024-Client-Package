...
class Client(UserClient):
    ...
    def team_name(self):
        ...
        """
        return 'SeanIsAProgrammerSometimes'
    ...
    def take_turn(self, turn, actions, world: GameBoard, mobbot: Avatar):
        ...
        elif current_tile.occupied_by.object_type == ObjectType.ORE_OCCUPIABLE_STATION:
        ...
        elif current_tile.occupied_by.object_type == self.my_station_type:
            ...
            for y in range(-1, 2):
                for mult in range(1, 10):
                    ...
                    if 0 <= new_y < len(gm) and 0 <= new_x < len(gm[0]):
                        if world.game_map[new_y][new_x].occupied_by != None and world.game_map[new_y][new_x].occupied_by.object_type == ObjectType.ORE_OCCUPIABLE_STATION:
